      ...
      <div className={`${faqStyles.container} ${faqStyles.grid}`}>
        ...
        <div className={faqStyles.card}>
          ...
          <p>
            ...
            blanditiis odio quas, sequi obcaecati, facilis similique nulla in
            fugit dolores sit aliquam, earum omnis facere eos vero illo
            inventore.
          </p>
          ...
          <p>
            ...
            exercitationem tempora enim maiores recusandae atque, iusto deleniti
            minus tempore vel dolorum illo nesciunt possimus saepe quod odit,
            inventore mollitia reiciendis.
          </p>
